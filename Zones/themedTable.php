...
?>
				...
				data-target="#add" data-id="<?= $row[0] ?>" id="addRow"><strong><span class="glyphicon glyphicon-plus"></span> Add Zone</strong></button>
				<br>
...
$areaID = $row[2];
$areaName;
$sql3 = "SELECT (`Name`) FROM Areas WHERE `ID`=$areaID";
...
<div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
				<h4 class="modal-title" id="myModalLabel">Add Zone Form</h4>
			</div>
			<div class="modal-body">
...
<script type="text/javascript">
	...
	{ 
		...
		// Call the web page that will get the list of
		$("#modal-content-add").load("addZone.php", function(response, status, xhr) 
		{
