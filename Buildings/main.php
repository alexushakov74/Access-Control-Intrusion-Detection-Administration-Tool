...
<ul class="nav nav-tabs nav-justified">
  ...
  <li role="presentation" class="active"><a href="http://ec2-54-175-213-117.compute-1.amazonaws.com/team1/Nick/Buildings/main.php"><span class="glyphicon glyphicon-home"></span> Buildings</a></li>
...
<script>
	...
	function loadThemedTable()
	{
		...
		$("#content").load("http://ec2-54-175-213-117.compute-1.amazonaws.com/team1/Nick/Buildings/themedTable.php");
	}
</script>