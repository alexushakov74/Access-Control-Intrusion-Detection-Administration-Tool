...
<ul class="nav nav-tabs nav-justified">
  ...
  <li role="presentation" class="active"><a href="http://ec2-54-175-213-117.compute-1.amazonaws.com/team1/Nick/Profiles/main.php"><span class="glyphicon glyphicon-file"></span> Profiles</a></li>  
...
<script>
	...
	function loadThemedTable()
	{
		...
		$("#content").load("http://ec2-54-175-213-117.compute-1.amazonaws.com/team1/Nick/Profiles/themedTable.php");
	}
</script>